...
static BROTLI_INLINE void AddMatch2(size_t distance, size_t len,
                                    size_t len_code, uint32_t* matches) {
  uint32_t match = (uint32_t)((distance << 5) + len_code);
  matches[0] = match;
  matches[1] = len;
}
...
/* This function is a stripped down version of the match finder above. Instead
   of searching through a bucket of matches trying to find a full or partial
   match and transforming it, it takes a DictWord representing a full match and
   transforms it. Some transforms are disabled: Cutoff transforms since the
   radix match finder does not find partial matches and prefix transforms due to
   performance reasons. The function only reports a single, possibly transformed
   match and its length instead of an array with matches and lengths. */
void BrotliTransformReducedDictionaryMatch(
    const BrotliEncoderDictionary* dictionary, const uint8_t* data,
  ...
  if (w.transform == 0) {
    ...
    if (l + 2 < max_length &&
        data[l - 1] == 'i' && data[l] == 'n' && data[l + 1] == 'g' &&
        data[l + 2] == ' ') {
      AddMatch2(id + 49 * n, l + 3, l, matches);
    }
    if (l + 6 >= max_length) {
      return;
    }
    ...
    /* Transforms "" + BROTLI_TRANSFORM_IDENTITY + <suffix> */
    if (s[0] == ' ') {
      AddMatch2(id + n, l + 1, l, matches);
      if (s[1] == 'a') {
        if (s[2] == ' ') {
          AddMatch2(id + 28 * n, l + 3, l, matches);
        } else if (s[2] == 's') {
          if (s[3] == ' ') AddMatch2(id + 46 * n, l + 4, l, matches);
        } else if (s[2] == 't') {
          if (s[3] == ' ') AddMatch2(id + 60 * n, l + 4, l, matches);
        } else if (s[2] == 'n') {
          if (s[3] == 'd' && s[4] == ' ') {
            AddMatch2(id + 10 * n, l + 5, l, matches);
          }
        }
      } else if (s[1] == 'b') {
        if (s[2] == 'y' && s[3] == ' ') {
          AddMatch2(id + 38 * n, l + 4, l, matches);
        }
      } else if (s[1] == 'i') {
        if (s[2] == 'n') {
          if (s[3] == ' ') AddMatch2(id + 16 * n, l + 4, l, matches);
        } else if (s[2] == 's') {
          if (s[3] == ' ') AddMatch2(id + 47 * n, l + 4, l, matches);
        }
      } else if (s[1] == 'f') {
        if (s[2] == 'o') {
          if (s[3] == 'r' && s[4] == ' ') {
            AddMatch2(id + 25 * n, l + 5, l, matches);
          }
        } else if (s[2] == 'r') {
          if (s[3] == 'o' && s[4] == 'm' && s[5] == ' ') {
            AddMatch2(id + 37 * n, l + 6, l, matches);
          }
        }
      } else if (s[1] == 'o') {
        if (s[2] == 'f') {
          if (s[3] == ' ') AddMatch2(id + 8 * n, l + 4, l, matches);
        } else if (s[2] == 'n') {
          if (s[3] == ' ') AddMatch2(id + 45 * n, l + 4, l, matches);
        }
      } else if (s[1] == 'n') {
        if (s[2] == 'o' && s[3] == 't' && s[4] == ' ') {
          AddMatch2(id + 80 * n, l + 5, l, matches);
        }
      } else if (s[1] == 't') {
        if (s[2] == 'h') {
          if (s[3] == 'e') {
            if (s[4] == ' ') AddMatch2(id + 5 * n, l + 5, l, matches);
          } else if (s[3] == 'a') {
            if (s[4] == 't' && s[5] == ' ') {
              AddMatch2(id + 29 * n, l + 6, l, matches);
            }
          }
        } else if (s[2] == 'o') {
          if (s[3] == ' ') AddMatch2(id + 17 * n, l + 4, l, matches);
        }
      } else if (s[1] == 'w') {
        if (s[2] == 'i' && s[3] == 't' && s[4] == 'h' && s[5] == ' ') {
          AddMatch2(id + 35 * n, l + 6, l, matches);
        }
      }
    } else if (s[0] == '"') {
      AddMatch2(id + 19 * n, l + 1, l, matches);
      if (s[1] == '>') {
        AddMatch2(id + 21 * n, l + 2, l, matches);
      }
    } else if (s[0] == '.') {
      AddMatch2(id + 20 * n, l + 1, l, matches);
      if (s[1] == ' ') {
        AddMatch2(id + 31 * n, l + 2, l, matches);
        if (s[2] == 'T' && s[3] == 'h') {
          if (s[4] == 'e') {
            if (s[5] == ' ') AddMatch2(id + 43 * n, l + 6, l, matches);
          } else if (s[4] == 'i') {
            if (s[5] == 's' && s[6] == ' ') {
              AddMatch2(id + 75 * n, l + 7, l, matches);
            }
          }
        }
      }
    } else if (s[0] == ',') {
      AddMatch2(id + 76 * n, l + 1, l, matches);
      if (s[1] == ' ') {
        AddMatch2(id + 14 * n, l + 2, l, matches);
      }
    } else if (s[0] == '\n') {
      AddMatch2(id + 22 * n, l + 1, l, matches);
      if (s[1] == '\t') {
        AddMatch2(id + 50 * n, l + 2, l, matches);
      }
    } else if (s[0] == ']') {
      AddMatch2(id + 24 * n, l + 1, l, matches);
    } else if (s[0] == '\'') {
      AddMatch2(id + 36 * n, l + 1, l, matches);
    } else if (s[0] == ':') {
      AddMatch2(id + 51 * n, l + 1, l, matches);
    } else if (s[0] == '(') {
      AddMatch2(id + 57 * n, l + 1, l, matches);
    } else if (s[0] == '=') {
      if (s[1] == '"') {
        AddMatch2(id + 70 * n, l + 2, l, matches);
      } else if (s[1] == '\'') {
        AddMatch2(id + 86 * n, l + 2, l, matches);
      }
    } else if (s[0] == 'a') {
      if (s[1] == 'l' && s[2] == ' ') {
        AddMatch2(id + 84 * n, l + 3, l, matches);
      }
    } else if (s[0] == 'e') {
      if (s[1] == 'd') {
        if (s[2] == ' ') AddMatch2(id + 53 * n, l + 3, l, matches);
      } else if (s[1] == 'r') {
        if (s[2] == ' ') AddMatch2(id + 82 * n, l + 3, l, matches);
      } else if (s[1] == 's') {
        if (s[2] == 't' && s[3] == ' ') {
          AddMatch2(id + 95 * n, l + 4, l, matches);
        }
      }
    } else if (s[0] == 'f') {
      if (s[1] == 'u' && s[2] == 'l' && s[3] == ' ') {
        AddMatch2(id + 90 * n, l + 4, l, matches);
      }
    } else if (s[0] == 'i') {
      if (s[1] == 'v') {
        if (s[2] == 'e' && s[3] == ' ') {
          AddMatch2(id + 92 * n, l + 4, l, matches);
        }
      } else if (s[1] == 'z') {
        if (s[2] == 'e' && s[3] == ' ') {
          AddMatch2(id + 100 * n, l + 4, l, matches);
        }
      }
    } else if (s[0] == 'l') {
      if (s[1] == 'e') {
        if (s[2] == 's' && s[3] == 's' && s[4] == ' ') {
          AddMatch2(id + 93 * n, l + 5, l, matches);
        }
      } else if (s[1] == 'y') {
        if (s[2] == ' ') AddMatch2(id + 61 * n, l + 3, l, matches);
      }
    } else if (s[0] == 'o') {
      if (s[1] == 'u' && s[2] == 's' && s[3] == ' ') {
        AddMatch2(id + 106 * n, l + 4, l, matches);
      }
    }
  }
  else if (w.transform == 1) {
    /* Cut transform */
    AddMatch2(id + 12 * n, l - 1, l, matches);
  }
  else {
    /* Set is_all_caps=0 for BROTLI_TRANSFORM_UPPERCASE_FIRST and
           is_all_caps=1 otherwise (BROTLI_TRANSFORM_UPPERCASE_ALL)
    ...
    const uint8_t* s;
    /* Transform "" + kUppercase{First,All} + "" */
    AddMatch2(id + (is_all_caps ? 44 : 9) * n, l, l, matches);
    ...
    s = &data[l];
    if (s[0] == ' ') {
      AddMatch2(id + (is_all_caps ? 68 : 4) * n, l + 1, l, matches);
    } else if (s[0] == '"') {
      AddMatch2(id + (is_all_caps ? 87 : 66) * n, l + 1, l, matches);
      if (s[1] == '>') {
        AddMatch2(id + (is_all_caps ? 97 : 69) * n, l + 2, l, matches);
      }
    } else if (s[0] == '.') {
      AddMatch2(id + (is_all_caps ? 101 : 79) * n, l + 1, l, matches);
      if (s[1] == ' ') {
        AddMatch2(id + (is_all_caps ? 114 : 88) * n, l + 2, l, matches);
      }
    } else if (s[0] == ',') {
      AddMatch2(id + (is_all_caps ? 112 : 99) * n, l + 1, l, matches);
      if (s[1] == ' ') {
        AddMatch2(id + (is_all_caps ? 107 : 58) * n, l + 2, l, matches);
      }
    } else if (s[0] == '\'') {
      AddMatch2(id + (is_all_caps ? 94 : 74) * n, l + 1, l, matches);
    } else if (s[0] == '(') {
      AddMatch2(id + (is_all_caps ? 113 : 78) * n, l + 1, l, matches);
    } else if (s[0] == '=') {
      if (s[1] == '"') {
        AddMatch2(id + (is_all_caps ? 105 : 104) * n, l + 2, l, matches);
      } else if (s[1] == '\'') {
        AddMatch2(id + (is_all_caps ? 116 : 108) * n, l + 2, l, matches);
      }
    }
  }
}
